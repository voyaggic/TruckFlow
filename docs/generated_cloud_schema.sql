...
BEGIN
  ...
  ALTER TABLE public."anpr_config" ADD CONSTRAINT anpr_config_updated_by_fkey FOREIGN KEY ("updated_by") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
  ALTER TABLE public."audit_log" ADD CONSTRAINT audit_log_actor_id_fkey FOREIGN KEY ("actor_id") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
  ALTER TABLE public."integrations" ADD CONSTRAINT integrations_connected_by_fkey FOREIGN KEY ("connected_by") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
  ...
  ALTER TABLE public."model_versions" ADD CONSTRAINT model_versions_deployed_by_fkey FOREIGN KEY ("deployed_by") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
  ...
  ALTER TABLE public."system_health_events" ADD CONSTRAINT system_health_events_acknowledged_by_fkey FOREIGN KEY ("acknowledged_by") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
  ...
  ALTER TABLE public."user_permissions" ADD CONSTRAINT user_permissions_granted_by_fkey FOREIGN KEY ("granted_by") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
  ...
  ALTER TABLE public."users" ADD CONSTRAINT users_revoked_by_fkey FOREIGN KEY ("revoked_by") REFERENCES public."users" ("id") DEFERRABLE INITIALLY DEFERRED ON DELETE SET NULL;
